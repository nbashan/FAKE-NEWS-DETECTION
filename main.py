from fake.textClassification import TextClassification
...
def init():
    ...
    return TextClassification(path,sheet_name_train,sheet_name_dev,sheet_name_test,feature_columns,label_column)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if choice == 1:
            ...
            method = input("method: ")
            while(method != "svc" and method != "rf" and method != "mlp" and method != "lr" and method != "mnb" and method != "lnr"):
                method = input("method: ")
